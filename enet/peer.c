...
enet_peer_send (ENetPeer * peer, enet_uint8 channelID, ENetPacket * packet)
{
   ...
   {
      enet_uint32 fragmentCount = ENET_HOST_TO_NET_32 ((u_long)((packet -> dataLength + fragmentLength - 1) / fragmentLength) ),
             ...
             fragmentOffset += (enet_uint32)fragmentLength)
      {
         ...
         command.sendFragment.totalLength = ENET_HOST_TO_NET_32 ((u_long)(packet -> dataLength));
...
enet_peer_reset (ENetPeer * peer)
{
    ...
    peer -> mtu = (enet_uint16)( peer -> host -> mtu );
