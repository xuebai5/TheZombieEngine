...
//nNebulaUsePackage(nfsaudioserver3);
...
NebulaMain(int argc, char * argv[])
{
    ...
    kernelServer->AddPackage(nundoserver);
    ...
    nConjurerApp *app = (nConjurerApp *) kernelServer->New("nconjurerapp", "/app/conjurer");
    app->SetCompanyName("The Zombie Team");
    app->SetAppName("Conjurer");
