...
#include "buildver.h"
//#include "wm3resource.h"
//#include "wm3resourceOverride.h"
...
class MorphR3 : public Modifier, TimeChangeCallback {
	public:
		...
		void GetClassName(TSTR& s) { s= TSTR("Morpher"); }  
		virtual Class_ID ClassID() { return MR3_CLASS_ID;}		
		RefTargetHandle Clone(RemapDir& remap = DefaultRemapDir());
		TCHAR *GetObjectName() { return "Morpher"; }
...
class M3Mat : public Mtl, public IReshading  {	
	public:
		...
		void GetClassName(TSTR& s) {s="Morpher";}  
