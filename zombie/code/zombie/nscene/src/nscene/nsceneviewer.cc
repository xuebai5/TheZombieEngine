...
#include "nscene/nsceneviewerapp.h"
...
//  const char* sceneserverArg = args.GetStringArg("-sceneserver", "nstdsceneserver");
    ...
    const char* stageArg  = args.GetStringArg("-stage", "home:bin/nstdlight.tcl");
    ...
    nSceneViewerApp viewerApp(&kernelServer);
