...
//------------------------------------------------------------------------------
#include "nscene/nsubdivshapenode.h"
...
*/
bool
nSubdivShapeNode::Apply(nSceneGraph* sceneGraph)
{
    nShapeNode::Apply(sceneGraph);
    
    // nSubdivShapeNode::ApplyShader
    ...
    // nSubdivShapeNode::ApplyGeometry
...
*/
bool
nSubdivShapeNode::Render(nSceneGraph* N_IFDEF_ASSERTS(sceneGraph), nEntityObject* N_IFDEF_ASSERTS(entityObject) )
{
    n_assert(sceneGraph);
