...
*/
void 
nShader2::ClearParameter(nShaderState::Param /*p*/)
{
    // empty
}
...
*/
bool
nShader2::BeginParameterSlot()
{
    n_assert(!this->inParameterSlot);
    this->inParameterSlot = true;
    return true;
}
...
*/
void 
nShader2::LogShaderParams() const
{
    /// empty
}
#endif
