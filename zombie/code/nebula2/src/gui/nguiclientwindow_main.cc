...
//    this->SetFadeOutTime(0.2f);
    this->SetFadeInTime(0.0f);
    this->SetFadeOutTime(0.0f);
}
...
//------------------------------------------------------------------------------
/**
    Writes out Rect info
*/
void nGuiClientWindow::OutputRect()
{
    n_printf("Rect is(%f, %f, %f, %f)\n", this->rect.v0.x, this->rect.v0.y, this->rect.v1.x, this->rect.v1.y);
    n_printf("Width: %f, Height: %f\n", this->rect.width(), this->rect.height());
}
