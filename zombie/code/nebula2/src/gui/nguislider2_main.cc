...
nGuiSlider2::OnShow()
{
    ...
    if (this->horizontal)
    {
        ...
        knob->SetMinSize(vector2(0.005f, this->arrowBtnSize.y));
...
nGuiSlider2::Render()
{
    if (this->IsShown())
    {
        ...
        nGuiBrush * brushtopaint = &this->disabledBrush;
        if (this->IsEnabled()) { brushtopaint = &this->defaultBrush; }
        nGuiServer::Instance()->DrawBrush(this->GetScreenSpaceRect(), *brushtopaint);
