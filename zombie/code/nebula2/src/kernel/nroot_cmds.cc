...
#ifndef NGAME
static void n_binddirtydependence(void*, nCmd*);
#endif
...
*/
void n_initcmds_nRoot(nClass *cl)
{
    cl->BeginCmds();
...
#ifndef NGAME
    cl->AddCmd("v_binddirtydependence_o",   'ZBDD', n_binddirtydependence);
#endif
    cl->EndCmds();
}
...
/**
    ...
    @info
    Create a dependency link between me and the passed object. 
*/
static void n_binddirtydependence(void *o, nCmd *cmd)
{
    nRoot *self = (nRoot *) o;
    self->BindDirtyDependence((nObject*) cmd->In()->GetO());
}
