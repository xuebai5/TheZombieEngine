...
static void n_configtimesafety(void *, nCmd *);
static void n_configprofilersafety(void *, nCmd *);
...
void n_initcmds_nTimeServer(nClass *cl)
{
    ...
    cl->AddCmd("v_configtimesafety_b",      'CTSA', n_configtimesafety);
    cl->AddCmd("v_configprofilersafety_b",  'CTSA', n_configprofilersafety);
    cl->EndCmds();
}
...
/**
    ...
    @info
    Request safe time method.
*/
static void n_configtimesafety(void *o, nCmd *cmd)
{
    nTimeServer *self = (nTimeServer *) o;
    self->ConfigTimeSafety(cmd->In()->GetB());
}

//-------------------------------------------------------------------
/**
    @cmd
    configprofilersafety
    ...
    @info
    Rquest safe profiler method.
*/
static void n_configprofilersafety(void *o, nCmd *cmd)
{
    nTimeServer *self = (nTimeServer *) o;
    self->ConfigProfilerSafety(cmd->In()->GetB());
}
