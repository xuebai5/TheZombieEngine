        ...
        while (file->GetS(line, sizeof(line))) 
        {
            ...
            if (kw) 
            {
                ...
                else if (strcmp(kw, "f") == 0) 
                {
                    ...
                    {
                        char *slash;
                        if ( 0 != (slash=strchr(t0s, '/')) ) 
                        {
                            *slash=0;
                        }
                        if ( 0 != (slash=strchr(t1s, '/')) ) 
                        {
                            *slash=0;
                        }
                        if ( 0 != (slash=strchr(t2s, '/')) ) 
                        {
                            *slash=0;
                        }
                        Triangle triangle;
        ...
        while (file->GetS(line, sizeof(line)))
        {
            ...
            else if (0 == strcmp(keyWord, "v"))
            {
                ...
                if (vertexComponents & Vertex::COLOR)
                {
                    ...
                    vertex.SetColor(vector4((float) atof(aStr), (float) atof(gStr), (float) atof(bStr), (float) atof(rStr)));
                }
                if (vertexComponents & Vertex::UV0)
                {
                    const char* uStr = strtok(0, N_WHITESPACE);
