...
public:
    ...
    public:
        ...
        void TimeToIndex(float time, int& keyIndex0, int& keyIndex1, float& inbetween,nAnimation::Group::LoopType loopType, float velocityFactor = 1.f) const;
    ...
    virtual void SampleCurves(float time, int groupIndex, int firstCurveIndex, int numCurves, vector4* keyArray,nAnimation::Group::LoopType loopType, float velocityFactor = 1.f);
    ...
    /// get key at
    virtual const vector4 GetKeyAt(int index) const;
...
inline
void
nAnimation::Group::TimeToIndex(float time, int& keyIndex0, int& keyIndex1, float& inbetween, nAnimation::Group::LoopType loopType, float velocityFactor) const
{
    float frame  = time * velocityFactor / (this->keyTime);
