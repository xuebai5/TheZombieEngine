 ...
 *
 * RCS: @(#) $Id: tclCompile.h,v 1.1 2003/03/23 17:12:26 brucem Exp $
 */
...
#define TclEmitInstInt4(op, i, envPtr) \
    ...
    *(envPtr)->codeNext++ = (unsigned char) (op); \
    *(envPtr)->codeNext++ = \
        (unsigned char) (((unsigned int) (i) >> 24) & 0xFF); \
    *(envPtr)->codeNext++ = \
        (unsigned char) (((unsigned int) (i) >> 16) & 0xFF); \
    *(envPtr)->codeNext++ = \
        (unsigned char) (((unsigned int) (i) >>  8) & 0xFF); \
    *(envPtr)->codeNext++ = \
        (unsigned char) (((unsigned int) (i)      ) & 0xFF)
...
#define TclStoreInt4AtPtr(i, p) \
    *(p)   = (unsigned char) (((unsigned int) (i) >> 24) & 0xFF); \
    *(p+1) = (unsigned char) (((unsigned int) (i) >> 16) & 0xFF); \
    *(p+2) = (unsigned char) (((unsigned int) (i) >>  8) & 0xFF); \
    *(p+3) = (unsigned char) (((unsigned int) (i)      ) & 0xFF)
