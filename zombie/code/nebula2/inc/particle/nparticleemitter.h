...
public:
    ...
    /// get timestamp for last frame
    nTime GetPrevTime() const;
    /// set timestamp for last time it was alive
    void SetLastTimeAlive(nTime time);
    /// get timestamp for last time it was alive
    nTime GetLastTimeAlive() const;
...
protected:
    ...
    nTime           keepAlive;              ///< how long keep it alive after last update
    nTime           lastTimeAlive;          ///< timestamp for last frame it was alive
...
inline
nTime
nParticleEmitter::GetPrevTime() const
{
...
inline
void
nParticleEmitter::SetLastTimeAlive(nTime lastTime)
{
    this->lastTimeAlive = lastTime;
}
...
inline
nTime
nParticleEmitter::GetLastTimeAlive() const
{
