...
public:
    ...
    /// set if particles should be stretched using the velocity curve
    void SetStretchUsingCurve(bool value);
...
inline
void
nParticle2Emitter::SetTransform(const matrix44& transform)
{
...
inline
void
nParticle2Emitter::SetStartTime(nTime time)
{
    this->startTime = time;
}
...
inline
void
nParticle2Emitter::SetEmitterMesh(nMesh2* newMesh)
{
...
inline
bool
nParticle2Emitter::GetLoop() const
{
    return this->loop;
}
...
inline
void
nParticle2Emitter::SetEmissionDuration(nTime time)
{
...
inline
void
nParticle2Emitter::SetLoop(bool b)
{
    this->loop = b;
}
...
inline
void
nParticle2Emitter::SetStretchUsingCurve(bool value)
{
