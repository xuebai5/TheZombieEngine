...
public:
    ...
    /// deinitialize the dynamic mesh (release resources)
    bool Deinitialize();
    ...
    /// Check if the dynamic mesh has the specified vertex components 
    bool HasAllVertexComponents(int comp) const;
