...
protected:
    ...
    /// transform vertex, need the lock vertex buffer
    virtual bool Transform(float* vb, int idxBegin, int numVertices, const matrix44& matrix);
    /// transform texture coord, need the lock vertex buffer
    virtual bool TransformUv(int layer, float* vb, int idxBegin, int numVertices, const matrix33& matrix);
...
private:
	...
	void TransformCoordArray(float* vb, int offsetComponent, const matrix44& matrix, int numVertices, bool normal);
	/// Transform texture coordinates
	void TransformTexCoordArray(float* vb, int offsetComponent, const matrix33& matrix, int numVertices);
