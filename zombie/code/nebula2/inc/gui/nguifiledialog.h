...
protected:
    ...
    nRef<nGuiTextLabel> refCurFolderLabel;
    nRef<nGuiTextEntry> refFolderTextEntry;

    nRef<nGuiTextLabel> refFolderLabel;
    nRef<nGuiDirLister> refFolderLister;    // folders in current level

    nRef<nGuiTextLabel> refDirLabel;
    nRef<nGuiDirLister> refDirLister;       // files in current folder
