...
class nInputMapping : public nHashNode 
{
    ...
    int maskFlags;          ///< combination of shift, alt, ctrl flags
...
public:
    enum {
        ...
        N_IMSTATE_CTRL_FLAG     = (1<<6),
        N_IMSTATE_SHIFT_FLAG    = (1<<7),
        N_IMSTATE_MENU_FLAG      = (1<<8),
        N_IMSTATE_QUALIFIERS    = N_IMSTATE_MENU_FLAG|N_IMSTATE_CTRL_FLAG|N_IMSTATE_SHIFT_FLAG,
    };
