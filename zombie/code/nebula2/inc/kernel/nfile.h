...
public:
    ...
    /// get the filename of the currently opened file object
    const nString & GetFilename() const;
    /// get the access mode in which the file was opened
    const nString & GetAccessMode() const;
...
protected:
    ...
    /// file name
    nString fname;
    /// access mode in which the file was opened
    nString accessMode;
    /// current line number
    ushort lineNumber;
    bool isOpen;
