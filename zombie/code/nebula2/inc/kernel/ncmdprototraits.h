...
#define NCMDPROTO_PROTO_IN7(t1,t2,t3,t4,t5,t6,t7)       t1 inarg1, t2 inarg2, t3 inarg3, t4 inarg4, t5 inarg5, t6 inarg6, t7 inarg7
#define NCMDPROTO_PROTO_IN8(t1,t2,t3,t4,t5,t6,t7,t8)    t1 inarg1, t2 inarg2, t3 inarg3, t4 inarg4, t5 inarg5, t6 inarg6, t7 inarg7, t8 inarg8
#define NCMDPROTO_PROTO_IN9(t1,t2,t3,t4,t5,t6,t7,t8,t9) t1 inarg1, t2 inarg2, t3 inarg3, t4 inarg4, t5 inarg5, t6 inarg6, t7 inarg7, t8 inarg8, t9 inarg9
...
#define NCMDPROTO_PROTO_OUT7(t1,t2,t3,t4,t5,t6,t7)      t1 outarg1, t2 outarg2, t3 outarg3, t4 outarg4, t5 outarg5, t6 outarg6, t7 outarg7
#define NCMDPROTO_PROTO_OUT8(t1,t2,t3,t4,t5,t6,t7,t8)   t1 outarg1, t2 outarg2, t3 outarg3, t4 outarg4, t5 outarg5, t6 outarg6, t7 outarg7, t8 outarg8
#define NCMDPROTO_PROTO_OUT9(t1,t2,t3,t4,t5,t6,t7,t8,t9) t1 outarg1, t2 outarg2, t3 outarg3, t4 outarg4, t5 outarg5, t6 outarg6, t7 outarg7, t8 outarg8, t9 outarg9
...
#define NCMDPROTO_PROTO_OUT_PRECOMMA_JOIN7(NUMIN,NUMOUT,ARGS)   NCMDPROTO_COMMA(NUMIN) NCMDPROTO_PROTO_OUT ## NUMOUT ## ARGS
#define NCMDPROTO_PROTO_OUT_PRECOMMA_JOIN8(NUMIN,NUMOUT,ARGS)   NCMDPROTO_COMMA(NUMIN) NCMDPROTO_PROTO_OUT ## NUMOUT ## ARGS
#define NCMDPROTO_PROTO_OUT_PRECOMMA_JOIN9(NUMIN,NUMOUT,ARGS)   NCMDPROTO_COMMA(NUMIN) NCMDPROTO_PROTO_OUT ## NUMOUT ## ARGS
...
#define NCMDPROTO_REPEATIO_INARG(NumIn)             \
    ...
    NCMDPROTO_REPEATIO_INOUTARG(NumIn,7)            \
    NCMDPROTO_REPEATIO_INOUTARG(NumIn,8)            \
    NCMDPROTO_REPEATIO_INOUTARG(NumIn,9)
...
#define NCMDPROTO_REPEATIO_ALL()                    \
    ...
    NCMDPROTO_REPEATIO_INARG(7)                     \
    NCMDPROTO_REPEATIO_INARG(8)                     \
    NCMDPROTO_REPEATIO_INARG(9)
...
public:
    ...
    typedef typename Loki::TL::TypeAtNonStrict<TListIn, 6>::Result TPI7;
    typedef typename Loki::TL::TypeAtNonStrict<TListIn, 7>::Result TPI8;
    typedef typename Loki::TL::TypeAtNonStrict<TListIn, 8>::Result TPI9;
    ...
    typedef typename Loki::TL::TypeAtNonStrict<TListOut, 6>::Result TPO7;
    typedef typename Loki::TL::TypeAtNonStrict<TListOut, 7>::Result TPO8;
    typedef typename Loki::TL::TypeAtNonStrict<TListOut, 8>::Result TPO9;
    ...
    static char * CalcPrototype(char * signature, const char * cmdname)
    {
        ...
        if (NumOutArgs >= 7)
        {
            strcat(ptr, NCMDPROTO_GETSIGNATURE(TPO7) );
        }
        if (NumOutArgs >= 8)
        {
            strcat(ptr, NCMDPROTO_GETSIGNATURE(TPO8) );
        }
        if (NumOutArgs >= 9)
        {
            strcat(ptr, NCMDPROTO_GETSIGNATURE(TPO9) );
        }
        ...
        *ptr = 0;
        ...
        if (NumInArgs >= 7)
        {
            strcat(ptr, NCMDPROTO_GETSIGNATURE(TPI7) );
        }
        if (NumInArgs >= 8)
        {
            strcat(ptr, NCMDPROTO_GETSIGNATURE(TPI8) );
        }
        if (NumInArgs >= 9)
        {
            strcat(ptr, NCMDPROTO_GETSIGNATURE(TPI9) );
        }
