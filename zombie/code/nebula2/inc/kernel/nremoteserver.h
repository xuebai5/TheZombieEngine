...
private:
    class nClientContext : public nNode
    {
        ...
        /// set cwd object
        void SetCwd(nObject* obj);
        /// get cwd object
        nObject* GetCwd() const;
    ...
    nObject* GetClientCwd(int clientId);
    /// set cwd in client context
    void SetClientCwd(int clientId, nObject* cwd);
...
inline
void
nRemoteServer::nClientContext::SetCwd(nObject* obj)
{
    n_assert(obj);
    this->refCwd = obj;
}
