...
public:
    ...
    static nThreadId GetCurrentThreadId();
    /// mark the curerrent thread is main thread
    static void MarkAsMainThread();
    /// return if the current thread is the main thread
    static bool IsTheMainThread( nThreadId id);
