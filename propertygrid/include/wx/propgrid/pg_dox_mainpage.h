...
/**
    ...
    Sections that are new in 1.1.0 have NEW! appended to their name. Sections with
    ...
    \section featurelist wxPropertyGrid Features (NEW!)
    ...
    - Unspecified, empty values (wxPropertyGrid::SetPropertyValueUnspecified,
      wxPropertyGrid::IsPropertyValueUnspecified).
    ...
    - Changing set of choices used by wxEnumProperty or wxMultiChoiceProperty
    ...
    TextCtrl, Choice, CheckBox, TextCtrlAndButton, and ChoiceAndButton.
    ...
    \code
        pg->SetPropertyAttribute(pg->GetRoot(),wxPG_BOOL_USE_CHECKBOX,(long)1,wxPG_RECURSE);
    \endcode
    ...
    \subsection faq Frequently Asked Questions (NEW!)

    See http://wxpropgrid.sourceforge.net/faq.html for most recent faq.
    ...
    \section neweditors Creating Custom Property Editor (NEW!)
