...
public:
    ...
    virtual void SetCallBackDialog( wxObject& ) {}
    ...
    */
    inline bool SetChoices( const wxArrayString& labels,
                            const wxArrayInt& values = *((const wxArrayInt*)NULL) );
...
public:
    ...
    /** Constructor. */
    wxPGChoices( const wxArrayString& labels, const wxArrayInt& values = *((const wxArrayInt*)NULL) )
    {
        Init();
        Set(labels,values);
    }
    ...
    */
    ...
    /*
    inline int GetRefCount() const { return m_data->m_refCount; }
    ...
    // Must be static because it may delete "itself".
    static void UnRef( wxPGChoices* choices );
    */
    ...
    */
    ...
    /** If there is choices with given id, returns it. Otherwise creates a new
        one.
    */
    //static wxPGChoices* GetOrCreate(size_t id);
...
extern WXDLLIMPEXP_PG wxPGProperty* wxAdvImageFileProperty( const wxString& label, const wxString& name = wxPG_LABEL );

#endif // DOXYGEN

#if 1   
WX_PG_DECLARE_PROPERTY_WITH_DECL(wxStringCallBackProperty,const wxString&,wxEmptyString,WXDLLIMPEXP_PG)
#endif
...
public:
    ...
    */
    wxPGId GetPropertyByName( wxPGNameStr name, wxPGNameStr subname ) const;
    ...
    */
    ...
    inline wxPGChoices& GetPropertyChoices( wxPGNameStr name )
    {
    ...
    inline const wxPGEditor* GetPropertyEditor( wxPGNameStr name ) const
    {
    ...
    inline wxBitmap* GetPropertyImage ( wxPGNameStr name ) const
    {
    ...
    /** Returns help string associated with a property. */
    inline wxString GetPropertyHelpString ( wxPGNameStr name ) const
    {
    ...
    */
    ...
    inline wxValidator* GetPropertyValidator ( wxPGNameStr name )
    {
    ...
    */
    ...
    inline bool IsPropertyKindOf( wxPGNameStr name, wxPGPropertyClassInfo& info )
    {
...
#else
    inline bool IsPropertyUnspecified ( wxPGNameStr name ) { return IsPropertyValueUnspecified(GetPropertyByName(name)); }
#endif
    ...
    */
    ...
    inline wxPGId ReplaceProperty( wxPGNameStr name, wxPGProperty* property )
    {
    ...
    */
    ...
    /** Set choices of a property to specified set of labels and values.
    */
    inline void SetPropertyChoices(wxPGNameStr name, wxPGChoices& choices)
    {
    ...
    */
    ...
    inline void SetPropertyChoicesExclusive( wxPGNameStr name )
    {
        wxPGId id = GetPropertyByName(name);
        wxASSERT( wxPGIdIsOk(id) );
        wxPGIdToPtr(id)->SetChoicesExclusive();
    ...
    */
    ...
    /** Sets editor control of a property. As editor argument, use
        ...
        CheckBox, TextCtrlAndButton, and ChoiceAndButton.
    */
    ...
    inline void SetPropertyEditor ( wxPGNameStr name, const wxPGEditor* editor )
    {
    ...
    */
    ...
    inline void SetPropertyImage ( wxPGNameStr name, wxBitmap& bmp )
    {
    ...
    */
    ...
    inline void SetPropertyValidator ( wxPGNameStr name, wxValidator& validator )
    {
        SetPropertyValidator(GetPropertyByName(name),validator);
    }
#endif

    /** Call when property stops using its wxPGChoicesData. Used mostly internally. */
    //static void UnRefChoices( wxPGChoicesData* choices );
...
public:
	...
	*/
    ...
    void SetSizeControl( const wxSize& value ) {
            sizeControl = value;
    }

    wxPoint positionControl;

    void SetPositionControl( const wxPoint& value ) {
    ...
    const wxSize GetSizeControl() {
        if( m_selected )
        {
            wxRect grect(GetEditorWidgetRect(m_selected));

            return grect.GetSize();
        }
        return sizeControl;
    }
    ...
    */
    ...
    inline wxPGId AppendBool ( const wxString& label, const wxString& name = wxPG_LABEL, bool value = false )
    {
        return Append ( wxBoolProperty(label,name,value) );
    }
#endif
    ...
    */
    ...
    wxPGProperty* GetPropertyByCoolLabel( const wxString& label ) const {
        return wxPropertyContainerMethods::GetPropertyByName(label).GetPropertyPtr();
    }
    ...
    */
    //void OptimizeSplitterPosition( bool subProps = true );
    ...
    */
    ...
    /** Selects all (text) in primary editor. */
    ...
    */
    ...
    /** Returns id for primary editor control. */
    //inline int GetSubId1() const { return wxPG_SUBID1 /*GetId();*/ }

    /** Returns id for secondary editor control. */
    //inline int GetSubId2() const { return wxPG_SUBID1; /*return GetId()+1;*/ }
...
protected:
    ...
    bool HandleMouseLeftDoubleClick( int x, unsigned int y, wxMouseEvent &event );
...
//private:
    ...
    */
    ...
    //int GetOptimalSplitterPos( wxClientDC& dc, wxPGPropertyWithChildren* pwc, bool subProps );
...
BEGIN_DECLARE_EVENT_TYPES()
    ...
    //DECLARE_EXPORTED_EVENT_TYPE(WXDLLIMPEXP_PG, wxEVT_PG_CONTROL_UPDATED,    1779)
    DECLARE_EXPORTED_EVENT_TYPE(WXDLLIMPEXP_PG, wxEVT_PG_PAGE_CHANGED,       1780)
    DECLARE_EXPORTED_EVENT_TYPE(WXDLLIMPEXP_PG, wxEVT_PG_LEFT_DCLICK,        1781)
    DECLARE_EXPORTED_EVENT_TYPE(WXDLLIMPEXP_PG, wxEVT_PG_CREATECTRL,         1782)
    DECLARE_EXPORTED_EVENT_TYPE(WXDLLIMPEXP_PG, wxEVT_PG_DESTROYCTRL,         1783)
END_DECLARE_EVENT_TYPES()
    ...
    enum {
        ...
        //wxEVT_PG_CONTROL_UPDATED,
        wxEVT_PG_PAGE_CHANGED,
        wxEVT_PG_LEFT_DCLICK,
        wxEVT_PG_CREATECTRL,
        wxEVT_PG_DESTROYCTRL,
    };
#endif
...
//#define EVT_PG_CONTROL_UPDATED(id, fn)       DECLARE_EVENT_TABLE_ENTRY( wxEVT_PG_CONTROL_UPDATED, id, -1, (wxObjectEventFunction) (wxEventFunction)  wxStaticCastEvent( wxPropertyGridEventFunction, & fn ), (wxObject *) NULL ),
...
#define EVT_PG_LEFT_DCLICK(id, fn)          DECLARE_EVENT_TABLE_ENTRY( wxEVT_PG_LEFT_DCLICK, id, -1, (wxObjectEventFunction) (wxEventFunction)  wxStaticCastEvent( wxPropertyGridEventFunction, & fn ), (wxObject *) NULL ),
#define EVT_PG_CREATECTRL(id, fn)          DECLARE_EVENT_TABLE_ENTRY( wxEVT_PG_CREATECTRL, id, -1, (wxObjectEventFunction) (wxEventFunction)  wxStaticCastEvent( wxPropertyGridEventFunction, & fn ), (wxObject *) NULL ),
#define EVT_PG_DESTROYCTRL(id, fn)          DECLARE_EVENT_TABLE_ENTRY( wxEVT_PG_DESTROYCTRL, id, -1, (wxObjectEventFunction) (wxEventFunction)  wxStaticCastEvent( wxPropertyGridEventFunction, & fn ), (wxObject *) NULL ),
