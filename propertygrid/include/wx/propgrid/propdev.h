...
public:
    ...
    //wxString            m_uintTemplate; // default is "%u"

    //wxPGChoicesData     m_emptyChoicesData;
    ...
    //int                 m_uintRadix; // need to store inorder to render template correctly
    ...
    - Event handling:
      ...
      wxPropertyGrid::OnCustomEditorEvent. For Example:
        \code
            ...
            // NOTE: This event is actually automatically conveyed, but
...
#define WX_PG_IMPLEMENT_STRING_CALLBACK_PROPERTY(NAME) \
class wxPG_PROPCLASS(NAME) : public wxLongStringPropertyClass \
{ \
    WX_PG_DECLARE_DERIVED_PROPERTY_CLASS() \
public: \
