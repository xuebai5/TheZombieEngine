#--------------------------------------------------------------------------
# Visual Studio 2008 (10.0) Project & Solution Generator
#
# (c) 2019 M.A. Garcias
#
...
class vstudio10:
    ...
    def __init__(self, buildSys):
        ...
        self.description = 'Microsoft Visual Studio 2008 (10.0) ' \
                           'Project & Solution Generator. This generator also ' \
                           'works with the Visual C++ 2008 Express Edition.'
        self.vcprojLocation = ''
        self.incDirStr = ''
        self.libDirStr = ''
    ...
    def Generate(self, workspaceNames):
        defaultLocation = os.path.join('build', 'vstudio10')
        ...
        try:
            ...
            self.buildSys.logger.exception('Exception in vstudio10.Generate()')
    ...
    def GenerateSolution(self, workspace):
        ...
        try:
            ...
            # header
            slnFile.write('Microsoft Visual Studio Solution File, Format Version 10.00\n' \
    ...
    def writeProjectConfig(self, target, workspace, projFile, debugMode):
        ...
        libInDirs = os.path.join(libraryDir, 'win32', 'vstudio10') + ';' + os.path.join(libraryDir, 'win32')
        ...
        if debugMode == 1:
            ...
            libInDirs = os.path.join(libraryDir, 'win32d', 'vstudio10') + ';' + os.path.join(libraryDir, 'win32d') + libInDirs
