--------------------------------------------------------------------------------
--   data/scripts/startup.lua
--
--   This is the central Conjurer runtime startup script.
...
dofile (mangle('luascript:conjurer_terrain.lua'))
dofile (mangle('luascript:conjurer_level.lua'))
