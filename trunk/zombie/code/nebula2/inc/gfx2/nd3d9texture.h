...
public:
    ...
    /// lock a rectangle of a 2D texture, returns pointer and pitch
...
private:
    ...
    /// return the dx filter
    DWORD GetDXFilter(Filter filter) const;
    ...
    // debug surface for displaying the render target on the frame buffer
