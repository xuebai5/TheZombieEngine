...
public:
    ...
    /// set value for a load flag
    void SetLoadFlags(uint loadFlags);
    /// get value for a load flag
    const uint GetLoadFlags() const;
    /// set a technique
...
inline
void
nShader2::SetLoadFlags(const uint flags)
{
