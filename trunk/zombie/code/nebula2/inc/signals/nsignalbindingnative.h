...
template <class TClass, class TRefClass, class TR, class TListIn, class TListOut>
...
public:
    ...
    /// constructor
    nSignalBindingNative(TClass * obj, TRefClass * refObj, TMemberFunction memfun, int priority);
    /// destructor
...
template <class TClass, class TRefClass, class TR, class TListIn, class TListOut>
inline
nSignalBindingNative<TClass,TRefClass,TR,TListIn,TListOut>::nSignalBindingNative(TClass * o, TRefClass * ro, TMemberFunction memfun, int priority) :
...
template <class TClass, class TRefClass, class TR, class TListIn, class TListOut>
inline
nSignalBindingNative<TClass,TRefClass,TR,TListIn,TListOut>::~nSignalBindingNative()
{
    /// empty
}
...
inline
bool
nSignalBindingNative<TClass,TRefClass,TR,TListIn,TListOut>::Invoke(nCmd * cmd)
{
    cmd->Rewind();
    return TCmdDispatcher::Dispatch(this->object, this->memf, cmd);
}
...
inline
bool
nSignalBindingNative<TClass,TRefClass,TR,TListIn,TListOut>::Invoke(va_list args)
{
    /// XXX: how to pass the return value from TValistDispatcher::Dispatch ?
    TValistDispatcher::Dispatch<Traits::ReturnsVoid>(this->object, this->memf, args);
    return true;
}
...
inline
const char *
nSignalBindingNative<TClass,TRefClass,TR,TListIn,TListOut>::GetProtoDef() const
{
...
inline
bool
nSignalBindingNative<TClass,TRefClass,TR,TListIn,TListOut>::IsBoundWithObject(const nObject * objectPtr) const
{
...
inline
bool
nSignalBindingNative<TClass,TRefClass,TR,TListIn,TListOut>::IsValid() const
{
