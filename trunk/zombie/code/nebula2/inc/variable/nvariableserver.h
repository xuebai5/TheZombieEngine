...
public:
    ...
    /// signal that a global variable has been edited
    NSIGNAL_DECLARE('MGVC', void, GlobalVariableChanged, 0, (), 0, ());
...
inline
const char*
nVariableServer::FourCCToString(nFourCC fourcc, char* buf, int N_IFDEF_ASSERTS(bufSize) )
{
    n_assert(bufSize >= 5);
