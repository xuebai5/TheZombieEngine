...
public:
    ...
    const static nFourCC InvalidHandle = 0xffffffff;

    /// default constructor
    nVariable();
    /// bool constuctor
    nVariable(Handle h, bool val);
    /// int constuctor
...
*/
inline
nVariable::nVariable(Handle h, bool val) :
    handle(h),
    type(Bool),
    boolVal(val)
{
