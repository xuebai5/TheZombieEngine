...
#ifndef HALFPI
#define HALFPI (1.5707963267948966192313216916395f)
#endif
...
#define N_PI        PI
#define N_HALFPI    HALFPI
#define N_TWOPI     TWOPI
...
//------------------------------------------------------------------------------
/**
    Normalize an angular value into the range [ -PI, PI ]
*/
inline
float n_normalangle2( float a )
{
    while( a > N_PI )
    {
        a -= N_TWOPI;
