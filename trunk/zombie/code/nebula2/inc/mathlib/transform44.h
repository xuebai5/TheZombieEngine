...
{
    n_assert2( this->flags & NoMatrix, "get invalid translation");
...
{
    this->euler = v;
    this->flags |= (Dirty | UseEuler | NoMatrix );
}
...
{
    n_assert2( (this->flags & NoMatrix) && (this->flags & UseEuler )  , "get invalid translation");
    return this->euler;
}
...
{
    n_assert2( (this->flags & NoMatrix)    , "get invalid scale");
    return this->scale;
}
