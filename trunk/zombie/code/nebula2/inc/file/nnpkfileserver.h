...
private:
    /// extension of npk files
    static const char * NPK_EXTENSION;
    ...
    /// maximum number of LRFU nodes in the heap
    const static int MAX_NPK_NODES;

    /// LRFU heap of npk nodes
    typedef nLRFUHeap< nNpkFileWrapper* > NPKHeap;
    NPKHeap loadedNpks;
