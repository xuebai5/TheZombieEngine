...
nMesh2::UnloadResource()
{
    ...
    // better way to handle mesh unloading
    gfxServer->OnUnloadMesh(this);
...
nMesh2::LoadFile(nMeshLoader* meshLoader)
{
    ...
    {
        NLOG(resource, (NLOGUSER | 0, "nMesh2: could not open file '%s'!\n", filename.Get()));
        return false;
    }
...
//------------------------------------------------------------------------------
/**
    Transform vertex coordinates by the given matrix.

    - 19-Apr-06 cristobal.castillo  created
*/
bool 
nMesh2::Transform(float*  /*vb*/, int /*idxBegin*/, int /*numVertices*/, const matrix44& /*matrix*/)
{
    n_assert_always();
...
//------------------------------------------------------------------------------
/**
    Transform texture coordinates by the given matrix.

    - 19-Apr-06     ma.garcias   created
*/
bool
nMesh2::TransformUv(int /*layer*/, float* /*vb*/, int /*idxBegin*/, int /*numVertices*/, const matrix33& /*matrix*/)
{
    n_assert_always();
