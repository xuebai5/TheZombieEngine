...
static void n_setminsize(void* slf, nCmd* cmd);
static void n_getminsize(void* slf, nCmd* cmd);
static void n_setmaxsize(void* slf, nCmd* cmd);
static void n_getmaxsize(void* slf, nCmd* cmd);
...
*/
void
n_initcmds_nGuiWidget(nClass* cl)
{
    cl->BeginCmds();
    ...
    cl->AddCmd("v_setminsize_ff",                'STMS', n_setminsize);
    cl->AddCmd("ff_getminsize_v",                'GTMS', n_getminsize);
    cl->AddCmd("v_setmaxsize_ff",                'STXS', n_setmaxsize);
    cl->AddCmd("ff_getmaxsize_v",                'GTXS', n_getmaxsize);
...
/**
    ...
    v
    @info
    Set reference minimum size for layouts
*/
static void
n_setminsize(void* slf, nCmd* cmd)
{
    nGuiWidget* self = (nGuiWidget*) slf;
    vector2 v;
    v.x = cmd->In()->GetF();
...
/**
    ...
    f(x0), f(x1)
    @info
    Get reference minimum size for layouts
*/
static void
n_getminsize(void* slf, nCmd* cmd)
{
    nGuiWidget* self = (nGuiWidget*) slf;
    vector2 v = self->GetMinSize();
    cmd->Out()->SetF(v.x);
    cmd->Out()->SetF(v.y);
}
...
/**
    ...
    v
    @info
    Set reference maximum size for layouts
*/
static void
n_setmaxsize(void* slf, nCmd* cmd)
{
    nGuiWidget* self = (nGuiWidget*) slf;
    vector2 v;
    v.x = cmd->In()->GetF();
...
/**
    ...
    f(x0), f(x1)
    @info
    Get reference maximum size for layouts
*/
static void
n_getmaxsize(void* slf, nCmd* cmd)
{
    nGuiWidget* self = (nGuiWidget*) slf;
    vector2 v = self->GetMaxSize();
    cmd->Out()->SetF(v.x);
    cmd->Out()->SetF(v.y);
}
