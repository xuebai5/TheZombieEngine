...
NSIGNAL_DEFINE(nVariableServer, GlobalVariableChanged);
...
nVariableServer::SetGlobalVariable(const nVariable& var)
{
    ...
    this->SignalGlobalVariableChanged(this);
}
...
{
    this->SetGlobalVariable(nVariable(varHandle, f));
}
...
{
    this->SetGlobalVariable(nVariable(varHandle, i));
}
...
{
    this->SetGlobalVariable(nVariable(varHandle, v));
}
...
{
    this->SetGlobalVariable(nVariable(varHandle, s));
}
