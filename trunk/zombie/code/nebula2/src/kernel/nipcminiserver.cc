        ...
        else
        {
            ...
            if (curString) do
            {
                ...
                if (!systemMessage)
                {
                    ...
                    nMsgNode *msgNode = n_new(nMsgNode((void*) curString, static_cast<int>( strlen(curString) + 1 ) ));
                    msgNode->SetPtr( reinterpret_cast<void*>( size_t( this->clientId ) ));
            ...
            } while ( 0!= (curString = msgBuffer.GetNextString()) );
        }
