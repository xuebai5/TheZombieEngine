...
*/
void
nAudioServer3::StartSound(nSound3* N_IFDEF_ASSERTS(s))
{
    n_assert(s);
    n_assert(this->inBeginScene);
}
...
*/
void
nAudioServer3::UpdateSound(nSound3* N_IFDEF_ASSERTS(s))
{
    n_assert(s);
    n_assert(this->inBeginScene);
}
...
*/
void
nAudioServer3::StopSound(nSound3* N_IFDEF_ASSERTS(s))
{
    n_assert(s);
    n_assert(this->inBeginScene);
}
