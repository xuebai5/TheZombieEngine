...
main(int argc, const char** argv)
{
    ...
    bool quadArg               = args.GetBoolArg("-quad");
    ...
    if (quadArg)
    {
        n_printf("-> generating edge quads...\n");
        if (!mesh.CreateEdgeQuads())
        {
            n_message("Warning: the mesh volume isn't closed; it will render cracked shadows.\n");
        }
    }
