...
/**
    resource log level
    0 - error loading resources
    
    log groups
    ASYNCHRONOUS IO - log asynchronous operations
*/
static const char * logGroups[] = 
{
    "Asynchronous IO",
    "Shader",
    0
};
NCREATELOGLEVELGROUP_REL(resource, "Resources" , true, 0, logGroups, NLOGDEF);
