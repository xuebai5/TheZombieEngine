...
//------------------------------------------------------------------------------
class nConjurerApp : public nCommonApp
{
public:
    /// control mode
    enum ControlMode
    ...
    nConjurerApp();
    /// destructor
    virtual ~nConjurerApp();
    /// get instance pointer
    static nConjurerApp* Instance();
...
protected:
    ...
    /// create application-specific scene server
...
inline 
nConjurerApp *
nConjurerApp::Instance()
{
    return (nConjurerApp *) nApplication::Instance();
}
...
inline
void
nConjurerApp::SetControlMode(ControlMode mode)
{
...
*/
inline
nConjurerApp::ControlMode
nConjurerApp::GetControlMode() const
{
...
inline
void
nConjurerApp::SetLevelFile(const char* filename)
{
...
inline
const char*
nConjurerApp::GetLevelFile() const
{
...
inline
void
nConjurerApp::SetSceneFile(const char* filename)
{
...
inline
const char*
nConjurerApp::GetSceneFile() const
{
...
inline
void
nConjurerApp::SetLoadClassName(const char* classname)
{
...
inline
const char*
nConjurerApp::GetLoadClassName() const
{
...
inline
void
nConjurerApp::SetAnimState(const int animStateIndex)
{
...
inline
const int
nConjurerApp::GetAnimState() const
{
...
inline
void
nConjurerApp::SetScriptServerClass(const char* type)
{
...
inline
const char*
nConjurerApp::GetScriptServerClass() const
{
...
inline
void
nConjurerApp::SetViewportLayout(const char* layoutFile)
{
...
inline
const char *
nConjurerApp::GetViewportLayout() const
{
...
inline
void
nConjurerApp::SetOverlayEnabled(bool b)
{
...
inline
bool
nConjurerApp::GetOverlayEnabled() const
{
...
inline
void 
nConjurerApp::SetWatch(const char* name)
{
...
inline
void 
nConjurerApp::SetGUIScriptFile(const char* scriptfilename)
{
...
inline
const char* 
nConjurerApp::GetGuiScriptFile() const
{
...
inline 
const bool 
nConjurerApp::IsRenderWindowEmbedded() const
{
...
inline
void 
nConjurerApp::SetRenderWindowEmbedded( const bool is )
{
...
inline
void 
nConjurerApp::SetTempWorkingCopyDir(const char* dirPath)
{
...
inline
const char * 
nConjurerApp::GetTempWorkingCopyDir() const
{
...
inline
void 
nConjurerApp::SetTemporaryModeEnabled(bool enabled)
{
...
inline
bool
nConjurerApp::GetTemporaryModeEnabled()
{
...
inline
void
nConjurerApp::SetInitState( const nString & state )
{
...
inline
const nString &
nConjurerApp::GetInitState() const
{
...
inline
void
nConjurerApp::SetPhysicsEnabled(bool value)
{
...
inline
bool
nConjurerApp::IsPhysicsEnabled() const
{
...
inline
void
nConjurerApp::SetAttachEnabled(bool value)
{
...
inline
bool
nConjurerApp::IsAttachEnabled() const
{
...
inline
void
nConjurerApp::SetRenderEnabled(bool value)
{
...
inline
bool
nConjurerApp::IsRenderEnabled() const
{
