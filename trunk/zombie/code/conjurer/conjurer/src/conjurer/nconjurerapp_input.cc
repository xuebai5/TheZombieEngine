...
*/
void 
nConjurerApp::MoveCameraToEntity(nEntityObjectId entityId)
{
...
*/
void 
nConjurerApp::MoveCameraToSelection()
{
    nAppViewport* curViewport = this->refViewportUI->GetCurrentViewport();
...
*/
void 
nConjurerApp::OpenPreview(const char* className)
{
