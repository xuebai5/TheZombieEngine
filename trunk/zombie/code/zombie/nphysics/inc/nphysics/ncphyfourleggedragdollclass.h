#ifndef NC_PHYFOURLEGGEDRAGDOLLCLASS_H
#define NC_PHYFOURLEGGEDRAGDOLLCLASS_H
...
//-----------------------------------------------------------------------------
class ncPhyFourleggedRagDollClass : public ncPhysicsObjClass
{

    NCOMPONENT_DECLARE(ncPhyFourleggedRagDollClass,ncPhysicsObjClass);
...
public:
    ...
    /// set scavenger min-max angles
    void SetScavengerAngles();
#endif
