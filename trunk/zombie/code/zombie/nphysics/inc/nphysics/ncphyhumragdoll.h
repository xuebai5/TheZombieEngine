#ifndef NC_PHYHUMRAGDOLL_H
#define NC_PHYHUMRAGDOLL_H

//-----------------------------------------------------------------------------
/**
    @class ncPhyHumRagDoll
...
//-----------------------------------------------------------------------------
class ncPhyHumRagDoll : public ncPhyRagDoll
{

    NCOMPONENT_DECLARE(ncPhyHumRagDoll,ncPhyRagDoll);
...
N_CMDARGTYPE_NEW_TYPE(ncPhyHumRagDoll::which, "i", (value = (ncPhyHumRagDoll::which) cmd->In()->GetI()), (cmd->Out()->SetI(int(value)))  );
