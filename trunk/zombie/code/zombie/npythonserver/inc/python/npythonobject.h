...
typedef struct    {
    ...
    nRef<nObject> *nebula_object;
} NebulaObject;

#define NebulaObject_Check(v) ((v)->ob_type == &Nebula_Type)

// functions to work with list of created objects
NebulaObject *CreatedObjectsList_GetObject(nObject* real_neb_obj);
int CreatedObjectsList_AddObject(NebulaObject *nebula_object, nObject* real_neb_obj);

NebulaObject * NebulaObject_New(nObject *nebulaObj);
nObject * NebulaObject_GetPointer(NebulaObject * self);
...
int NebulaObject_CallPObjectFunction(NebulaObject *self, char *name,
                                     PyObject * args,
                                     PyObject ** returndata);
int NebulaObject_CallNebulaFunction(nObject* o, char * name,
