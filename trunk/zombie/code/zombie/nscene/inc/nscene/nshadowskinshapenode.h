...
//------------------------------------------------------------------------------
class nShadowSkinShapeNode : public nSceneNode
{
public:
    /// constructor
    ...
    /// called by scene graph when attaching nodes to the scene
...
inline
nSkinShapeNode *
nShadowSkinShapeNode::GetSkinShapeNode()
{
    n_assert(this->parent->GetClass() == kernelServer->FindClass("nskinshapenode"));
    return (nSkinShapeNode *) this->parent;
}
