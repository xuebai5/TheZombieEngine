...
#ifndef NGAME
static void n_setparticletexture(void* slf, nCmd* cmd);
static void n_getparticletexture(void* slf, nCmd* cmd);
static void n_setparticlemesh(void* slf, nCmd* cmd);
static void n_getparticlemesh(void* slf, nCmd* cmd);
static void n_getfuncdestblend(void* slf, nCmd* cmd);
static void n_setfuncdestblend(void* slf, nCmd* cmd);
static void n_setfuncsrcblend(void* slf, nCmd* cmd);
static void n_getfuncsrcblend(void* slf, nCmd* cmd);
#endif
//------------------------------------------------------------------------------
/**
    @scriptclass
...
*/
void
n_initcmds_nParticleShapeNode(nClass* cl)
{
    cl->BeginCmds();
...
#ifndef NGAME
    cl->AddCmd("v_setparticletexture_s", 'CSPT', n_setparticletexture);
    cl->AddCmd("s_getparticletexture_v", 'CGPT', n_getparticletexture);
    cl->AddCmd("v_setparticlemesh_s", 'CSPM', n_setparticlemesh);
    cl->AddCmd("s_getparticlemesh_v", 'CGPM', n_getparticlemesh);
    cl->AddCmd("v_setfuncdestblend_i", 'CSFD', n_setfuncdestblend);
    cl->AddCmd("i_getfuncdestblend_v", 'CGDD', n_getfuncdestblend);
    cl->AddCmd("v_setfuncsrcblend_i", 'CSFS', n_setfuncsrcblend);
    cl->AddCmd("i_getfuncsrcblend_v", 'CGFS', n_getfuncsrcblend);
#endif
    cl->EndCmds();
}
...
*/
static void
n_setfuncdestblend(void* slf, nCmd* cmd)
{
    nParticleShapeNode* self = (nParticleShapeNode*) slf;
    self->SetFuncDestBlend( cmd->In()->GetI() );
}
...
*/
static void
n_getfuncdestblend(void* slf, nCmd* cmd)
{
    nParticleShapeNode* self = (nParticleShapeNode*) slf;
    cmd->Out()->SetI( self->GetFuncDestBlend() ); 
}
...
*/
static void
n_setfuncsrcblend(void* slf, nCmd* cmd)
{
    nParticleShapeNode* self = (nParticleShapeNode*) slf;
    self->SetFuncSrcBlend( cmd->In()->GetI() );
}
...
*/
static void
n_getfuncsrcblend(void* slf, nCmd* cmd)
{
    nParticleShapeNode* self = (nParticleShapeNode*) slf;
    cmd->Out()->SetI( self->GetFuncSrcBlend() ); 
}
...
*/
static void
n_setparticletexture(void* slf, nCmd* cmd)
{
    nParticleShapeNode* self = (nParticleShapeNode*) slf;
    self->SetParticleTexture( cmd->In()->GetS() );
}
...
*/
static void
n_getparticletexture(void* slf, nCmd* cmd)
{
    nParticleShapeNode* self = (nParticleShapeNode*) slf;
    cmd->Out()->SetS( self->GetParticleTexture().Get() ); // SetS copy the string
}
...
*/
static void
n_setparticlemesh(void* slf, nCmd* cmd)
{
    nParticleShapeNode* self = (nParticleShapeNode*) slf;
    self->SetParticleMesh( cmd->In()->GetS() );
}
...
*/
static void
n_getparticlemesh(void* slf, nCmd* cmd)
{
    nParticleShapeNode* self = (nParticleShapeNode*) slf;
    cmd->Out()->SetS( self->GetParticleMesh().Get() ); // SetS copy the string
}
