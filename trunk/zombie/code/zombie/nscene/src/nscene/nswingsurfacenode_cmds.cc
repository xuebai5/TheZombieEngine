...
*/
void
n_initcmds_nSwingSurfaceNode(nClass* cl)
{
    cl->BeginCmds();
...
{
    nSwingSurfaceNode* self = (nSwingSurfaceNode*) slf;
...
*/
bool
nSwingSurfaceNode::SaveCmds(nPersistServer* ps)
{
    if (nSurfaceNode::SaveCmds(ps))
    {
        nCmd* cmd;
