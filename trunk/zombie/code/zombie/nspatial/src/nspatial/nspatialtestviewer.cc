...
//------------------------------------------------------------------------------
/**
    @page NebulaToolsnviewer nspatialtestviewer
...
main(int argc, const char** argv)
{
    ...
    #ifdef __WIN32__
        nWin32LogHandler logHandler("nspatialtestviewer");
        kernelServer.SetLogHandler(&logHandler);
    #endif

    // initialize a viewer app object
    nSpatialTestViewerApp viewerApp(&kernelServer);
