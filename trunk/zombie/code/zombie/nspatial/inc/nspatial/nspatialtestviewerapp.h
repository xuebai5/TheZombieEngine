#ifndef N_SPATIALTESTVIEWER_H
#define N_SPATIALTESTVIEWER_H
//------------------------------------------------------------------------------
/**
    A test viewer class for nSpatialServer.
...
public:
    ...
    /// constructor
    nSpatialTestViewerApp(nKernelServer* ks);
    /// destructor
    virtual ~nSpatialTestViewerApp();
    /// set display mode
...
inline
void
nSpatialTestViewerApp::SetFeatureSetOverride(nGfxServer2::FeatureSet f)
{
...
nSpatialTestViewerApp::GetFeatureSetOverride() const
{
...
inline
bool
nSpatialTestViewerApp::IsOpen() const
{
    return this->isOpen;
}
...
inline
void
nSpatialTestViewerApp::SetDisplayMode(const nDisplayMode2& mode)
{
...
inline
const nDisplayMode2&
nSpatialTestViewerApp::GetDisplayMode() const
{
...
inline
void
nSpatialTestViewerApp::SetCamera(const nCamera2& cam)
{
    this->camera = cam;
}
...
inline
const nCamera2&
nSpatialTestViewerApp::GetCamera() const
{
    return this->camera;
}
...
inline
void
nSpatialTestViewerApp::SetControlMode(ControlMode mode)
{
...
*/
inline
nSpatialTestViewerApp::ControlMode
nSpatialTestViewerApp::GetControlMode() const
{
...
inline
void
nSpatialTestViewerApp::SetSceneFile(const char* filename)
{
...
inline
const char*
nSpatialTestViewerApp::GetSceneFile() const
{
...
inline
void
nSpatialTestViewerApp::SetProjDir(const char* name)
{
    this->projDir = name;
}
...
inline
const char*
nSpatialTestViewerApp::GetProjDir() const
{
...
inline
void
nSpatialTestViewerApp::SetSceneServerClass(const char* type)
{
...
inline
const char*
nSpatialTestViewerApp::GetSceneServerClass() const
{
...
inline
void
nSpatialTestViewerApp::SetScriptServerClass(const char* type)
{
...
inline
const char*
nSpatialTestViewerApp::GetScriptServerClass() const
{
...
inline
void
nSpatialTestViewerApp::SetStartupScript(const char* script)
{
...
inline
const char*
nSpatialTestViewerApp::GetStartupScript() const
{
...
inline
void
nSpatialTestViewerApp::SetStageScript(const char* script)
{
...
inline
const char*
nSpatialTestViewerApp::GetStageScript() const
{
...
inline
void
nSpatialTestViewerApp::SetInputScript(const char* script)
{
...
inline
const char*
nSpatialTestViewerApp::GetInputScript() const
{
...
inline
void
nSpatialTestViewerApp::SetOverlayEnabled(bool b)
{
...
inline
bool
nSpatialTestViewerApp::GetOverlayEnabled() const
{
