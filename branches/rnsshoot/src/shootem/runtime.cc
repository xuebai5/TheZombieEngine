...
main(int argc, const char** argv)
{
	...
	const char* projDirArg = args.GetStringArg("-proj", "home:data/shootem");
    ...
    #ifdef __WIN32__
        nWin32LogHandler logHandler("shootem");
    ...
    ShootemApp* app = n_new(ShootemApp);
